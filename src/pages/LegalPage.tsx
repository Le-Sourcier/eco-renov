...
const LegalPage: React.FC = () => {
  useEffect(() => {
    document.title = "Mentions Légales | Éco Subvention";
  }, []);
    ...
    <div className="container mx-auto px-4 py-24">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <div className="prose prose-sm">
          ...
          <p className="mb-4">Le site Éco Subvention est édité par :</p>
          <ul className="list-none pl-0 mb-4">
            <li>
              <strong>Société :</strong> Éco Subvention SAS
            </li>
            <li>
            ...
            <li>
              <strong>Siège social :</strong> 123 Avenue de l'Écologie, 75000
              Paris
            </li>
            <li>
            ...
            <li>
              <strong>TVA Intracommunautaire :</strong> FR 12 345678900
            </li>
          </ul>
          ...
          <p className="mb-4">
            L'ensemble du contenu du site (textes, images, vidéos, etc.) est
            protégé par le droit d'auteur. Toute reproduction, même partielle,
            est soumise à l'autorisation préalable d'Éco Subvention.
          </p>
          ...
          <p className="mb-4">
            <strong>Design et développement :</strong> Éco Subvention
            <br />
            <strong>Photos :</strong> Pexels, Unsplash
            <br />
