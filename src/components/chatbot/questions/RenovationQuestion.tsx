...
const RenovationQuestion: React.FC = () => {
  ...
  return (
    <div className="chat-question">
      ...
      >
        ...
        >
          <Flame
            size={24}
            className={`mr-3 ${
              renovationType === "chauffage" ? "text-primary" : "text-gray-500"
            }`}
          />
          <div className="text-left">
            <h4 className="font-medium">Chauffage</h4>
            <p className="text-sm text-gray-600">
              Pompe à chaleur, chaudière, poêle...
            </p>
          </div>
        </button>
        ...
        >
          <Layers
            size={24}
            className={`mr-3 ${
              renovationType === "isolation" ? "text-primary" : "text-gray-500"
            }`}
          />
          <div className="text-left">
        ...
        >
          <WindowIcon
            size={24}
            className={`mr-3 ${
              renovationType === "fenetres" ? "text-primary" : "text-gray-500"
            }`}
          />
          <div className="text-left">
        ...
        >
          <ListChecks
            size={24}
            className={`mr-3 ${
              renovationType === "multiple" ? "text-primary" : "text-gray-500"
            }`}
          />
          <div className="text-left">
      ...
      >
        Le montant des aides CEE varie selon le type de travaux. Des bonus sont
        accordés pour les rénovations globales.
      </motion.p>
    </div>
  );
};
