...
const IncomeQuestion: React.FC = () => {
  ...
  return (
    <div className="chat-question">
      ...
      >
        ...
        >
          <EuroIcon
            size={24}
            className={`mr-3 ${
              incomeLevel === "tres_modeste" ? "text-primary" : "text-gray-500"
            }`}
          />
          <div className="text-left">
            <h4 className="font-medium">Ménage très modeste</h4>
            <p className="text-sm text-gray-600">
              Revenu fiscal de référence &lt; 21 123€ (1 personne)
            </p>
          </div>
        </button>
        ...
        >
          <EuroIcon
            size={24}
            className={`mr-3 ${
              incomeLevel === "modeste" ? "text-primary" : "text-gray-500"
            }`}
          />
          <div className="text-left">
            <h4 className="font-medium">Ménage modeste</h4>
            <p className="text-sm text-gray-600">
              Revenu fiscal de référence &lt; 25 714€ (1 personne)
            </p>
          </div>
        </button>
        ...
        >
          <EuroIcon
            size={24}
            className={`mr-3 ${
              incomeLevel === "intermediaire" ? "text-primary" : "text-gray-500"
            }`}
          />
          <div className="text-left">
            <h4 className="font-medium">Ménage intermédiaire</h4>
            <p className="text-sm text-gray-600">
              Revenu fiscal de référence &lt; 39 192€ (1 personne)
            </p>
          </div>
        </button>
        ...
        >
          <EuroIcon
            size={24}
            className={`mr-3 ${
              incomeLevel === "superieur" ? "text-primary" : "text-gray-500"
            }`}
          />
          <div className="text-left">
      ...
      >
        Les plafonds indiqués correspondent à un foyer d'une personne en
        Île-de-France. Les montants peuvent varier selon votre localisation et
