      ...
      >
        ...
        >
          <Home
            size={24}
            className={`mr-3 ${
              housingType === "maison" ? "text-primary" : "text-gray-500"
            }`}
          />
          <div className="text-left">
            <h4 className="font-medium">Maison individuelle</h4>
            <p className="text-sm text-gray-600">
              Pavillon, maison de ville...
            </p>
          </div>
        </button>
        ...
        >
          <Building2
            size={24}
            className={`mr-3 ${
              housingType === "appartement" ? "text-primary" : "text-gray-500"
            }`}
          />
          <div className="text-left">
            <h4 className="font-medium">Appartement</h4>
            <p className="text-sm text-gray-600">
              En copropriété ou en monopropriété
            </p>
          </div>
        </button>
      </motion.div>
